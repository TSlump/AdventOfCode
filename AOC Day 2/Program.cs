...
bool IsSafelyIncreasing(List<string> levels)
{
    if (levels.Count < 2)
    {
        return false;
...
bool IsSafelyDecreasing(List<string> levels)
{
    if (levels.Count < 2)
    {
        return false;
...
bool IsSafelyIncreasingWithDampener(List<string> levels)
{
...
bool IsSafelyDecreasingWithDampener(List<string> levels)
{
